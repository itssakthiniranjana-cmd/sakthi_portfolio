      ...
      card.innerHTML = `
        ...
        <div class="project-card-thumb">
          <div class="project-card-thumb-inner">
            <img src="${project.image}?v=4" alt="${project.name} - ${project.categoryLabel || project.category} UX/UI &amp; Product Design by Sakthi Niranjana" class="project-card-img" loading="lazy" onerror="this.onerror=null; this.src='assets/img/projects/figmaprojects.jpg';">
