...
function initParallaxCard(card) {
  ...
  function updateTransform() {
    ...
    card.style.boxShadow = `${shadowX.toFixed(1)}px ${shadowY.toFixed(1)}px 45px rgba(106, 76, 147, 0.18), 0 10px 25px rgba(0, 0, 0, 0.04)`;
    ...
    if (glare && bounds) {
      ...
      glare.style.background = `radial-gradient(circle 320px at ${glareX}% ${glareY}%, rgba(106, 76, 147, 0.22), rgba(255, 255, 255, 0.45) 35%, transparent 70%)`;
    }
